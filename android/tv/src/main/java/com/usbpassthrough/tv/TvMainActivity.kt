...
import com.usbpassthrough.UsbPassthroughService
import com.usbpassthrough.bridge.RustBridge
...
class TvMainActivity : ComponentActivity() {
    ...
    private var service: UsbPassthroughService? = null
    private var serviceBound = false

    private val serviceConnection = object : ServiceConnection {
        override fun onServiceConnected(name: ComponentName?, binder: IBinder?) {
            service = (binder as UsbPassthroughService.LocalBinder).getService()
            serviceBound = true
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bindService(
            Intent(this, UsbPassthroughService::class.java),
            serviceConnection,
